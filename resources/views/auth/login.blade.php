...
<body class="flex flex-col items-center justify-between min-h-screen bg-white text-black">
    ...
    <div class="w-full max-w-[50%] mt-[5vh]">
        ...
        <form action="{{ route('login.submit') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <div class="flex items-center bg-[var(--gris-bajito)] rounded-md px-4 py-3">
                    ...
                    <input id="passwordInput" type="password" name="password" placeholder="Contraseña" class="flex-1 bg-transparent outline-none placeholder-[var(--gris-oscuro)] istok-web-regular" required>
                    
                    <button type="button" onclick="togglePassword()" class="focus:outline-none text-[var(--gris-oscuro)] hover:text-[var(--azul)] transition">
                        
                        <svg id="eyeIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="w-6 h-6 fill-current">
                        ...
                        <svg id="eyeSlashIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="w-6 h-6 fill-current hidden">
        ...
        <div class="text-center mt-3">
            <a href="{{ route('password.request') }}" class="text-black istok-web-regular hover:text-[var(--azul)]">¿Olvidaste tu contraseña?</a>
        </div>
    </div>
