  ...
  <main class="min-h-screen flex items-center justify-center">
    <div class="w-full max-w-[900px] px-6 md:px-12 lg:px-20 py-16">
      ...
      <div class="bg-white shadow-sm rounded-xl p-8 text-center">
        ...
        <h1 class="text-3xl md:text-4xl istok-web-bold mb-4">¡Contraseña restablecida!</h1>
        ...
        <a href="{{ route('login') }}" class="inline-block mt-6 bg-[var(--azul)] text-white px-8 py-3 rounded-full hover:bg-[var(--azul-oscuro)] transition">
            Ir a Iniciar Sesión
        </a>
      </div>
    </div>
