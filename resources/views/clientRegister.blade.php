...
<body class="flex flex-col items-center min-h-screen bg-white text-black relative">
    ...
    <div class="w-full max-w-[50%] mt-[5vh] mb-10">
        ...
        <form id="registroForm" class="space-y-4">
            ...
            <div><label class="block font-bold mb-1 istok-web-bold">Nombre completo</label><div class="flex items-center bg-[var(--gris-bajito)] rounded-md px-4 py-3"><input name="nombre_comp" required type="text" class="flex-1 bg-transparent outline-none istok-web-regular" placeholder="Nombre Apellido"></div>@error('nombre_comp') <p class="text-red-600 text-sm mt-1">{{ $message }}</p> @enderror</div>
            <div><label class="block font-bold mb-1 istok-web-bold">Correo electrónico</label><div class="flex items-center bg-[var(--gris-bajito)] rounded-md px-4 py-3"><input name="email" required type="email" class="flex-1 bg-transparent outline-none istok-web-regular" placeholder="ejemplo@correo.com"></div>@error('email') <p class="text-red-600 text-sm mt-1">{{ $message }}</p> @enderror</div>
            <div><label class="block font-bold mb-1 istok-web-bold">Teléfono</label><div class="flex items-center bg-[var(--gris-bajito)] rounded-md px-4 py-3"><input name="telefono" type="tel" class="flex-1 bg-transparent outline-none istok-web-regular" placeholder="10 dígitos"></div>@error('telefono') <p class="text-red-600 text-sm mt-1">{{ $message }}</p> @enderror</div>
