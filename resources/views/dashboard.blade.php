...
<body class="antialiased istok-web-regular" 
                ...
                <article class="h-[180px] bg-white p-4 rounded-2xl border border-[var(--gris-medio-bajito)] shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between group">
                    ...
                    <div>
                        ...
                        <div class="flex items-baseline gap-1 mt-1">
                            ...
                            <span class="text-sm text-gray-400 font-medium">/ {{ $aforoMaximo }}</span> 
                        </div>
                    </div>
                </article>
  ...
  >
      ...
      >
          ...
          <!-- Body -->
            <div class="p-6">
                <form action="{{ route('configuracion.updateAforo') }}" method="POST"> 
                    @csrf
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            <input 
                                ...
                                placeholder="Ej. 150"
                                value="{{ $aforoMaximo }}" {{-- ⭐️ Valor traído de BD --}}
                                required
                            >
