        ...
        <form action="#" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <div class="flex items-center bg-[var(--gris-bajito)] rounded-md px-4 py-3">
                    <input type="email" placeholder="ejemplo@gmail.com" class="flex-1 bg-transparent outline-none placeholder-[var(--gris-oscuro)]">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex items-center bg-[var(--gris-bajito)] rounded-md px-4 py-3">
                    <input type="password" placeholder="Contraseña" class="flex-1 bg-transparent outline-none placeholder-[var(--gris-oscuro)]">
            ...
            <!-- Botón -->
            <button type="submit" class="w-full mt-2 bg-[var(--azul)] text-white py-3 rounded-full hover:bg-[var(--azul-oscuro)] transition">
                Iniciar sesión
            </button>
        </form>
